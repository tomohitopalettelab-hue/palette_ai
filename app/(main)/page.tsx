...
`;
  ...
  const PAL_TRUST_HEARING_FIELDS = [
    ...
    { key: 'priceInitial', label: '初期費用（円）', required: false, type: 'text' as const },
    { key: 'priceYen', label: '月額費用（円）', required: false, type: 'text' as const },
    { key: 'term', label: '契約期間（例: 12ヶ月）', required: false, type: 'text' as const },
    { key: 'dateContract', label: '契約日（例: 2026-04-04）', required: false, type: 'text' as const },
    { key: 'dateDelivery', label: '納品希望月（例: 2026-05）', required: false, type: 'text' as const },
